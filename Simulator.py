...
def get_options(args=None):
    ...
    parser.add_argument("-d", "--devices", type=int, default=30, help="Number of total devices in the simulation.")
    ...
    parser.add_argument("-p", "--percentage", type=float, default=1.0, help="Percentage of LoRa devices with respect to LoRa-E (i.e., 1.0 is all LoRa devices).")
