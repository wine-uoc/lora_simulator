...
fig = plt.figure()
plt.plot(devices_dr0_pl50, np.array(rxed_dr0_pl50) * np.array(devices_dr0_pl50), label=r'LoRa SF12 50B', linewidth=3.0, c='silver', linestyle='--')
plt.plot(devices_dr0_pl10, np.array(rxed_dr0_pl10) * np.array(devices_dr0_pl10), label=r'LoRa SF12 10B', linewidth=3.0, c='silver', linestyle='-')
plt.plot(devices_dr5_pl10, np.array(rxed_dr5_pl10) * np.array(devices_dr5_pl10), label=r'LoRa SF7 10B', linewidth=3.0, c='grey', linestyle=':')
plt.plot(devices_dr8_pl10, np.array(rxed_dr8_pl10) * np.array(devices_dr8_pl10), label=r'LoRa--E DR8 10B', linewidth=3.0, c='grey', linestyle='-')
...
plt.plot(devices_dr9_pl10, np.array(rxed_dr9_pl10) * np.array(devices_dr9_pl10), label=r'LoRa--E DR9 10B', linewidth=3.0, c='k', linestyle='-')
